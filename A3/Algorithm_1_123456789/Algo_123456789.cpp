...
#include "include/Algo_123456789.h"
...
Algo_123456789::Algo_123456789() : maxSteps(0), remainingSteps(0), start(Position{ 0,0 }), mapped{ Position{0,0} }, visited{ Position{0,0} }, returnPath{ {{0, 0}, {}} },
